 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class hs{constructor(e,t,i,n,r=!1,s="",o=!1,a=!1){this.secure=t,this.namespace=i,this.webSocketOnly=n,this.nodeAdmin=r,this.persistenceKey=s,this.includeNamespaceInQueryParams=o,this.isUsingEmulator=a,this._host=e.toLowerCase(),this._domain=this._host.substr(this._host.indexOf(".")+1),this.internalHost=lL.get("host:"+e)||this._host}isCacheableHost(){return"s-"===this.internalHost.substr(0,2)}isCustomHost(){return"firebaseio.com"!==this._domain&&"firebaseio-demo.com"!==this._domain}get host(){return this._host}set host(e){e!==this.internalHost&&(this.internalHost=e,this.isCacheableHost()&&lL.set("host:"+this._host,this.internalHost))}toString(){let e=this.toURLString();return this.persistenceKey&&(e+="<"+this.persistenceKey+">"),e}toURLString(){let e=this.secure?"https://":"http://",t=this.includeNamespaceInQueryParams?`?ns=${this.namespace}`:"";return`${e}${this.host}/${t}`}}function ho(e,t,i){let n;if(eh("string"==typeof t,"typeof type must == string"),eh("object"==typeof i,"typeof params must == object"),t===hn)n=(e.secure?"wss://":"ws://")+e.internalHost+"/.ws?";else if(t===hr)n=(e.secure?"https://":"http://")+e.internalHost+"/.lp?";else throw Error("Unknown connection type: "+t);(e.host!==e.internalHost||e.isCustomHost()||e.includeNamespaceInQueryParams)&&(i.ns=e.namespace);let r=[];return l4(i,(e,t)=>{r.push(e+"="+t)}),n+r.join("&")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ue{constructor(e){this.node_=e}getImmediateChild(e){return new ue(this.node_.getImmediateChild(e))}node(){return this.node_}}class ut{constructor(e,t){this.syncTree_=e,this.path_=t}getImmediateChild(e){let t=hP(this.path_,e);return new ut(this.syncTree_,t)}node(){return c6(this.syncTree_,this.path_)}}const ui=function(e,t,i){return e&&"object"==typeof e?(eh(".sv"in e,"Unexpected leaf node or priority contents"),"string"==typeof e[".sv"])?un(e[".sv"],t,i):"object"==typeof e[".sv"]?ur(e[".sv"],t):void eh(!1,"Unexpected server value: "+JSON.stringify(e,null,2)):e},un=function(e,t,i){if("timestamp"===e)return i.timestamp;eh(!1,"Unexpected server value: "+e)},ur=function(e,t,i){e.hasOwnProperty("increment")||eh(!1,"Unexpected server value: "+JSON.stringify(e,null,2));let n=e.increment;"number"!=typeof n&&eh(!1,"Unexpected increment value: "+n);let r=t.node();if(eh(null!=r,"Expected ChildrenNode.EMPTY_NODE for nulls"),!r.isLeafNode())return n;let s=r.getValue();return"number"!=typeof s?n:s+n};function us(e,t,i){let n;let r=ui(e.getPriority().val(),t.getImmediateChild(".priority"),i);if(!e.isLeafNode())return n=e,r!==e.getPriority().val()&&(n=n.updatePriority(new hJ(r))),e.forEachChild(hQ,(e,r)=>{let s=us(r,t.getImmediateChild(e),i);s!==r&&(n=n.updateImmediateChild(e,s))}),n;{let n=ui(e.getValue(),t,i);return n!==e.getValue()||r!==e.getPriority().val()?new hJ(n,h5(r)):e}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class uo{constructor(e="",t=null,i={children:{},childCount:0}){this.name=e,this.parent=t,this.node=i}}function ua(e,t){let i=t instanceof hI?t:new hI(t),n=e,r=hC(i);for(;null!==r;){let e=eq(n.node.children,r)||{children:{},childCount:0};n=new uo(r,n,e),r=hC(i=hS(i))}return n}function ul(e){return e.node.value}function uh(e,t){e.node.value=t,function e(t){null!==t.parent&&function(t,i,n){let r=void 0===ul(n)&&!uc(n),s=ej(t.node.children,i);r&&s?(delete t.node.children[i],t.node.childCount--,e(t)):r||s||(t.node.children[i]=n.node,t.node.childCount++,e(t))}(t.parent,t.name,t)}(e)}function uc(e){return e.node.childCount>0}function uu(e,t){l4(e.node.children,(i,n)=>{t(new uo(i,e,n))})}function ud(e){return new hI(null===e.parent?e.name:ud(e.parent)+"/"+e.name)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const up=/[\[\].#$\/\u0000-\u001F\u007F]/,uf=/[\[\].#$\u0000-\u001F\u007F]/,ug=function(e){return"string"==typeof e&&0!==e.length&&!up.test(e)},um=function(e){var t;return e&&(e=e.replace(/^\/*\.info(\/|$)/,"/")),"string"==typeof(t=e)&&0!==t.length&&!uf.test(t)},u_=function(e,t,i){let n=i instanceof hI?new hx(i,e):i;if(void 0===t)throw Error(e+"contains undefined "+hU(n));if("function"==typeof t)throw Error(e+"contains a function "+hU(n)+" with contents = "+t.toString());if(lG(t))throw Error(e+"contains "+t.toString()+" "+hU(n));if("string"==typeof t&&t.length>10485760/3&&eQ(t)>10485760)throw Error(e+"contains a string greater than 10485760 utf8 bytes "+hU(n)+" ('"+t.substring(0,50)+"...')");if(t&&"object"==typeof t){let i=!1,r=!1;if(l4(t,(t,s)=>{if(".value"===t)i=!0;else if(".priority"!==t&&".sv"!==t&&(r=!0,!ug(t)))throw Error(e+" contains an invalid key ("+t+") "+hU(n)+'.  Keys must be non-empty strings and can\'t contain ".", "#", "$", "/", "[", or "]"');n.parts_.length>0&&(n.byteLength_+=1),n.parts_.push(t),n.byteLength_+=eQ(t),hM(n),u_(e,s,n),function(e){let t=e.parts_.pop();e.byteLength_-=eQ(t),e.parts_.length>0&&(e.byteLength_-=1)}(n)}),i&&r)throw Error(e+' contains ".value" child '+hU(n)+" in addition to actual children.")}},uy=function(e,t){let i=t.path.toString();if("string"!=typeof t.repoInfo.host||0===t.repoInfo.host.length||!ug(t.repoInfo.namespace)&&"localhost"!==t.repoInfo.host.split(":")[0]||0!==i.length&&!um(i))throw Error(`${e} failed: url argument must be a valid firebase URL and the path can't contain ".", "#", "$", "[", or "]".`)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class uv{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function uw(e,t,i){!function(e,t){let i=null;for(let n=0;n<t.length;n++){let r=t[n],s=r.getPath();null===i||hL(s,i.path)||(e.eventLists_.push(i),i=null),null===i&&(i={events:[],path:s}),i.events.push(r)}i&&e.eventLists_.push(i)}(e,i),function(e,t){e.recursionDepth_++;let i=!0;for(let n=0;n<e.eventLists_.length;n++){let r=e.eventLists_[n];r&&(t(r.path)?(function(e){for(let t=0;t<e.events.length;t++){let i=e.events[t];if(null!==i){e.events[t]=null;let n=i.getEventRunner();lj&&lV("event: "+i.toString()),l3(n)}}}(e.eventLists_[n]),e.eventLists_[n]=null):i=!1)}i&&(e.eventLists_=[]),e.recursionDepth_--}(e,e=>hD(e,t)||hD(t,e))}class ub{constructor(e,t,i,n){this.repoInfo_=e,this.forceRestClient_=t,this.authTokenProvider_=i,this.appCheckProvider_=n,this.dataUpdateCount=0,this.statsListener_=null,this.eventQueue_=new uv,this.nextWriteId_=1,this.interceptServerDataCallback_=null,this.onDisconnect_=cs(),this.transactionQueueTree_=new uo,this.persistentConnection_=null,this.key=this.repoInfo_.toURLString()}toString(){return(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host}}function uI(e){var t;return(t=t={timestamp:function(e){let t=e.infoData_.getNode(new hI(".info/serverTimeOffset")).val()||0;return new Date().getTime()+t}(e)}).timestamp=t.timestamp||new Date().getTime(),t}function uT(e,t,i,n,r){e.dataUpdateCount++;let s=new hI(t);i=e.interceptServerDataCallback_?e.interceptServerDataCallback_(t,i):i;let o=[];if(r){if(n){let t=eV(i,e=>h5(e));o=function(e,t,i,n){let r=c3(e,n);if(!r)return[];{let n=c7(r),s=n.path,o=n.queryId,a=hO(s,t),l=cT.fromObject(i);return c8(e,s,new cf(cu(o),a,l))}}(e.serverSyncTree_,s,t,r)}else{let t=h5(i);o=function(e,t,i,n){let r=c3(e,n);if(null==r)return[];{let n=c7(r),s=n.path,o=n.queryId,a=hO(s,t);return c8(e,s,new cp(cu(o),a,i))}}(e.serverSyncTree_,s,t,r)}}else if(n){let t=eV(i,e=>h5(e));o=function(e,t,i){let n=cT.fromObject(i);return c5(e,new cf(cc(),t,n))}(e.serverSyncTree_,s,t)}else{let t=h5(i);o=c9(e.serverSyncTree_,s,t)}let a=s;o.length>0&&(a=uR(e,s)),uw(e.eventQueue_,a,o)}function uC(e,t){uE(e,"connected",t),!1===t&&function(e){uS(e,"onDisconnectEvents");let t=uI(e),i=cs();co(e.onDisconnect_,hT(),(n,r)=>{let s=us(r,new ut(e.serverSyncTree_,n),t);!function e(t,i,n){if(hA(i))t.value=n,t.children.clear();else if(null!==t.value)t.value=t.value.updateChild(i,n);else{let r=hC(i);t.children.has(r)||t.children.set(r,cs()),e(t.children.get(r),i=hS(i),n)}}(i,n,s)});let n=[];co(i,hT(),(t,i)=>{n=n.concat(c9(e.serverSyncTree_,t,i));let r=function(e,t){let i=ud(uN(e,t)),n=ua(e.transactionQueueTree_,t);return function(e,t,i){let n=e.parent;for(;null!==n;){if(t(n))return!0;n=n.parent}}(n,t=>{uO(e,t)}),uO(e,n),function e(t,i,n,r){n&&!r&&i(t),uu(t,t=>{e(t,i,!0,r)}),n&&r&&i(t)}(n,t=>{uO(e,t)}),i}(e,t);uR(e,r)}),e.onDisconnect_=cs(),uw(e.eventQueue_,hT(),n)}(e)}function uE(e,t,i){let n=new hI("/.info/"+t),r=h5(i);e.infoData_.updateSnapshot(n,r);let s=c9(e.infoSyncTree_,n,r);uw(e.eventQueue_,n,s)}function uS(e,...t){let i="";e.persistentConnection_&&(i=e.persistentConnection_.id+":"),lV(i,...t)}function uk(e,t,i){return c6(e.serverSyncTree_,t,i)||h9.EMPTY_NODE}function uR(e,t){let i=uN(e,t),n=ud(i),r=uP(e,i);return function(e,t,i){if(0===t.length)return;let n=[],r=[],s=t.filter(e=>0===e.status).map(e=>e.currentWriteId);for(let o=0;o<t.length;o++){let a=t[o],l=hO(i,a.path),h=!1,c;if(eh(null!==l,"rerunTransactionsUnderNode_: relativePath should not be null."),4===a.status)h=!0,c=a.abortReason,r=r.concat(c4(e.serverSyncTree_,a.currentWriteId,!0));else if(0===a.status){if(a.retryCount>=25)h=!0,c="maxretry",r=r.concat(c4(e.serverSyncTree_,a.currentWriteId,!0));else{let i=uk(e,a.path,s);a.currentInputSnapshot=i;let n=t[o].update(i.val());if(void 0!==n){u_("transaction failed: Data returned ",n,a.path);let t=h5(n);"object"==typeof n&&null!=n&&ej(n,".priority")||(t=t.updatePriority(i.getPriority()));let o=a.currentWriteId,l=uI(e),h=us(t,new ue(i),l);a.currentOutputSnapshotRaw=t,a.currentOutputSnapshotResolved=h,a.currentWriteId=e.nextWriteId_++,s.splice(s.indexOf(o),1),r=(r=r.concat(function(e,t,i,n,r){var s,o;return(s=e.pendingWriteTree_,o=r,eh(n>s.lastWriteId,"Stacking an older write on top of newer ones"),void 0===o&&(o=!0),s.allWrites.push({path:t,snap:i,writeId:n,visible:o}),o&&(s.visibleWrites=cE(s.visibleWrites,t,i)),s.lastWriteId=n,r)?c5(e,new cp(ch(),t,i)):[]}(e.serverSyncTree_,a.path,h,a.currentWriteId,a.applyLocally))).concat(c4(e.serverSyncTree_,o,!0))}else h=!0,c="nodata",r=r.concat(c4(e.serverSyncTree_,a.currentWriteId,!0))}}uw(e.eventQueue_,i,r),r=[],h&&(t[o].status=2,setTimeout(t[o].unwatcher,Math.floor(0)),t[o].onComplete&&("nodata"===c?n.push(()=>t[o].onComplete(null,!1,t[o].currentInputSnapshot)):n.push(()=>t[o].onComplete(Error(c),!1,null))))}uA(e,e.transactionQueueTree_);for(let e=0;e<n.length;e++)l3(n[e]);(function e(t,i=t.transactionQueueTree_){if(i||uA(t,i),ul(i)){let n=uP(t,i);eh(n.length>0,"Sending zero length transaction queue"),n.every(e=>0===e.status)&&function(t,i,n){let r=uk(t,i,n.map(e=>e.currentWriteId)),s=r,o=r.hash();for(let e=0;e<n.length;e++){let t=n[e];eh(0===t.status,"tryToSendTransactionQueue_: items in queue should all be run."),t.status=1,t.retryCount++;let r=hO(i,t.path);s=s.updateChild(r,t.currentOutputSnapshotRaw)}let a=s.val(!0);t.server_.put(i.toString(),a,r=>{uS(t,"transaction put response",{path:i.toString(),status:r});let s=[];if("ok"===r){let r=[];for(let e=0;e<n.length;e++)n[e].status=2,s=s.concat(c4(t.serverSyncTree_,n[e].currentWriteId)),n[e].onComplete&&r.push(()=>n[e].onComplete(null,!0,n[e].currentOutputSnapshotResolved)),n[e].unwatcher();uA(t,ua(t.transactionQueueTree_,i)),e(t,t.transactionQueueTree_),uw(t.eventQueue_,i,s);for(let e=0;e<r.length;e++)l3(r[e])}else{if("datastale"===r)for(let e=0;e<n.length;e++)3===n[e].status?n[e].status=4:n[e].status=0;else{l$("transaction at "+i.toString()+" failed: "+r);for(let e=0;e<n.length;e++)n[e].status=4,n[e].abortReason=r}uR(t,i)}},o)}(t,ud(i),n)}else uc(i)&&uu(i,i=>{e(t,i)})})(e,e.transactionQueueTree_)}(e,r,n),n}function uN(e,t){let i;let n=e.transactionQueueTree_;for(i=hC(t);null!==i&&void 0===ul(n);)n=ua(n,i),i=hC(t=hS(t));return n}function uP(e,t){let i=[];return function e(t,i,n){let r=ul(i);if(r)for(let e=0;e<r.length;e++)n.push(r[e]);uu(i,i=>{e(t,i,n)})}(e,t,i),i.sort((e,t)=>e.order-t.order),i}function uA(e,t){let i=ul(t);if(i){let e=0;for(let t=0;t<i.length;t++)2!==i[t].status&&(i[e]=i[t],e++);i.length=e,uh(t,i.length>0?i:void 0)}uu(t,t=>{uA(e,t)})}function uO(e,t){let i=ul(t);if(i){let n=[],r=[],s=-1;for(let t=0;t<i.length;t++)3===i[t].status||(1===i[t].status?(eh(s===t-1,"All SENT items should be at beginning of queue."),s=t,i[t].status=3,i[t].abortReason="set"):(eh(0===i[t].status,"Unexpected transaction status in abort"),i[t].unwatcher(),r=r.concat(c4(e.serverSyncTree_,i[t].currentWriteId,!0)),i[t].onComplete&&n.push(i[t].onComplete.bind(null,Error("set"),!1,null))));-1===s?uh(t,void 0):i.length=s+1,uw(e.eventQueue_,ud(t),r);for(let e=0;e<n.length;e++)l3(n[e])}}const uL=function(e,t){let i=uD(e),n=i.namespace;"firebase.com"===i.domain&&lz(i.host+" is no longer supported. Please use <YOUR FIREBASE>.firebaseio.com instead"),n&&"undefined"!==n||"localhost"===i.domain||lz("Cannot parse Firebase url. Please use https://<YOUR FIREBASE>.firebaseio.com"),i.secure||lK();let r="ws"===i.scheme||"wss"===i.scheme;return{repoInfo:new hs(i.host,i.secure,n,r,t,"",n!==i.subdomain),path:new hI(i.pathString)}},uD=function(e){let t="",i="",n="",r="",s="",o=!0,a="https",l=443;if("string"==typeof e){let h=e.indexOf("//");h>=0&&(a=e.substring(0,h-1),e=e.substring(h+2));let c=e.indexOf("/");-1===c&&(c=e.length);let u=e.indexOf("?");-1===u&&(u=e.length),t=e.substring(0,Math.min(c,u)),c<u&&(r=/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ux{constructor(e,t,i,n){this._repo=e,this._path=t,this._queryParams=i,this._orderByCalled=n}get key(){return hA(this._path)?null:hk(this._path)}get ref(){return new uM(this._repo,this._path)}get _queryIdentifier(){let e=l1(ci(this._queryParams));return"{}"===e?"default":e}get _queryObject(){return ci(this._queryParams)}isEqual(e){if(!((e=eZ(e))instanceof ux))return!1;let t=this._repo===e._repo,i=hL(this._path,e._path),n=this._queryIdentifier===e._queryIdentifier;return t&&i&&n}toJSON(){return this.toString()}toString(){return this._repo.toString()+function(e){let t="";for(let i=e.pieceNum_;i<e.pieces_.length;i++)""!==e.pieces_[i]&&(t+="/"+encodeURIComponent(String(e.pieces_[i])));return t||"/"}(this._path)}}class uM extends ux{constructor(e,t){super(e,t,new ce,!1)}get parent(){let e=hN(this._path);return null===e?null:new uM(this._repo,e)}get root(){let e=this;for(;null!==e.parent;)e=e.parent;return e}}eh(!c,"__referenceConstructor has already been defined"),c=uM,eh(!u,"__referenceConstructor has already been defined"),u=uM;const uU={};class uF{constructor(e,t){this._repoInternal=e,this.app=t,this.type="database",this._instanceStarted=!1}get _repo(){return this._instanceStarted||(function(e,t,i){if(e.stats_=hc(e.repoInfo_),e.forceRestClient_||("object"==typeof window&&window.navigator&&window.navigator.userAgent||"").search(/googlebot|google webmaster tools|bingbot|yahoo! slurp|baiduspider|yandexbot|duckduckbot/i)>=0)e.server_=new cn(e.repoInfo_,(t,i,n,r)=>{uT(e,t,i,n,r)},e.authTokenProvider_,e.appCheckProvider_),setTimeout(()=>uC(e,!0),0);else{if(null!=i){if("object"!=typeof i)throw Error("Only objects are supported for option databaseAuthVariableOverride");try{ex(i)}catch(e){throw Error("Invalid authOverride provided: "+e)}}e.persistentConnection_=new hj(e.repoInfo_,t,(t,i,n,r)=>{uT(e,t,i,n,r)},t=>{uC(e,t)},t=>{l4(t,(t,i)=>{uE(e,t,i)})},e.authTokenProvider_,e.appCheckProvider_,i),e.server_=e.persistentConnection_}e.authTokenProvider_.addTokenChangeListener(t=>{e.server_.refreshAuthToken(t)}),e.appCheckProvider_.addTokenChangeListener(t=>{e.server_.refreshAppCheckToken(t.token)}),e.statsReporter_=function(e,t){let i=e.toString();return hh[i]||(hh[i]=t()),hh[i]}(e.repoInfo_,()=>new cl(e.stats_,e.server_)),e.infoData_=new cr,e.infoSyncTree_=new c2({startListening:(t,i,n,r)=>{let s=[],o=e.infoData_.getNode(t._path);return o.isEmpty()||(s=c9(e.infoSyncTree_,t._path,o),setTimeout(()=>{r("ok")},0)),s},stopListening:()=>{}}),uE(e,"connected",!1),e.serverSyncTree_=new c2({startListening:(t,i,n,r)=>(e.server_.listen(t,n,i,(i,n)=>{let s=r(i,n);uw(e.eventQueue_,t._path,s)}),[]),stopListening:(t,i)=>{e.server_.unlisten(t,i)}})}(this._repoInternal,this.app.options.appId,this.app.options.databaseAuthVariableOverride),this._instanceStarted=!0),this._repoInternal}get _root(){return this._rootInternal||(this._rootInternal=new uM(this._repo,hT())),this._rootInternal}_delete(){return null!==this._rootInternal&&(function(e,t){let i=uU[t];i&&i[e.key]===e||lz(`Database ${t}(${e.repoInfo_}) has already been deleted.`),e.persistentConnection_&&e.persistentConnection_.interrupt("repo_interrupt"),delete i[e.key]}(this._repo,this.app.name),this._repoInternal=null,this._rootInternal=null),Promise.resolve()}_checkNotDeleted(e){null===this._rootInternal&&lz("Cannot call "+e+" on a deleted database.")}}hj.prototype.simpleListen=function(e,t){this.sendRequest("q",{p:e},t)},hj.prototype.echo=function(e,t){this.sendRequest("echo",{d:e},t)},lN=tE,tb(new e0("database",(e,{instanceIdentifier:t})=>(function(e,t,i,n,r){var s,o;let a,l,h,c,u=n||e.options.databaseURL;void 0===u&&(e.options.projectId||lz("Can't determine Firebase Database URL. Be sure to include  a Project ID when calling firebase.initializeApp()."),lV("Using default host for project ",e.options.projectId),u=`${e.options.projectId}-default-rtdb.firebaseio.com`);let d=uL(u,r),p=d.repoInfo;void 0!==X&&X.env&&(h=X.env.FIREBASE_DATABASE_EMULATOR_HOST),h?(c=!0,p=(d=uL(u=`http://${h}?ns=${p.namespace}`,r)).repoInfo):c=!d.repoInfo.secure;let f=r&&c?new ht(ht.OWNER):new he(e.name,e.options,t);return uy("Invalid Firebase Database URL",d),hA(d.path)||lz("Database URL must point to the root of a Firebase Database (not including a child path)."),new uF((s=p,o=new l8(e.name,i),(a=uU[e.name])||(a={},uU[e.name]=a),(l=a[s.toURLString()])&&lz("Database initialized multiple times. Please make sure the format of the database URL matches with each database() call."),l=new ub(s,!1,f,o),a[s.toURLString()]=l,l),e)})(e.getProvider("app").getImmediate(),e.getProvider("auth-internal"),e.getProvider("app-check-internal"),t),"PUBLIC").setMultipleInstances(!0)),tR(lk,lR,void 0),tR(lk,lR,"esm2017");const uj=document.querySelector(".sign-out-btn"),uq=document.querySelector(".sign-out-container"),uH=tS({apiKey:"AIzaSyDIt6ClvCkB36kNCs8suIEnlzg23Or1UqU",authDomain:"book-project-8a976.firebaseapp.com",projectId:"book-project-8a976",storageBucket:"book-project-8a976.appspot.com",messagingSenderId:"595782127929",appId:"1:595782127929:web:e819e67d1654c476ec98e8"});!function(e,t){let i=tI("object"==typeof e?e:tk(),"firestore").getImmediate({identifier:"string"==typeof e?e:"(default)"});if(!i._initialized){let e=eT("firestore");e&&function(e,t,i,n={}){var r;let s=(e=function(e,t){if("_delegate"in e&&(e=e._delegate),!(e instanceof t)){if(t.name===e.constructor.name)throw new aZ(aQ.INVALID_ARGUMENT,"Type does not match the expected instance. Did you pass a reference from a different Firestore SDK?");{let i=function(e){if(void 0===e)return"undefined";if(null===e)return"null";if("string"==typeof e)return e.length>20&&(e=`${e.substring(0,20)}...`),JSON.stringify(e);if("number"==typeof e||"boolean"==typeof e)return""+e;if("object"==typeof e){if(e instanceof Array)return"an array";{var t;let i=(t=e).constructor?t.constructor.name:null;return i?`a custom ${i} object`:"an object"}}return"function"==typeof e?"a function":aJ()}(e);throw new aZ(aQ.INVALID_ARGUMENT,`Expected type '${t.name}', but it was: ${i}`)}}return e}(e,lC))._getSettings(),o=`${t}:${i}`;if("firestore.googleapis.com"!==s.host&&s.host!==o&&function(e){if(aK.logLevel<=rC.WARN){let t=[].map(aX);aK.warn(`Firestore (${a$}): ${e}`,...t)}}("Host has been set in both settings() and connectFirestoreEmulator(), emulator host will be used."),e._setSettings(Object.assign(Object.assign({},s),{host:o,ssl:!1})),n.mockUserToken){let t,i;if("string"==typeof n.mockUserToken)t=n.mockUserToken,i=az.MOCK_USER;else{t=/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function(e,t){let i=tI(e,"auth");if(i.isInitialized()){let e=i.getImmediate();if(eB(i.getOptions(),null!=t?t:{}))return e;tW(e,"already-initialized")}return i.initialize({options:t})}(e,{popupRedirectResolver:ro,persistence:[nM,nv,nw]}),n=eE("authTokenSyncURL");if(n){let e=r_(n);eZ(i).beforeAuthStateChanged(e,()=>e(i.currentUser)),eZ(i).onIdTokenChanged(t=>e(t),void 0,void 0)}let r=eI("auth");return r&&function(e,t,i){let n=eZ(e);tK(n._canInitEmulator,n,"emulator-config-failed"),tK(/^https?:\/\//.test(t),n,"invalid-emulator-scheme");let r=!!(null==i?void 0:i.disableWarnings),s=i$(t),{host:o,port:a}=function(e){let t=i$(e),i=/(\/\/)?([^?#/]+)/.exec(e.substr(t.length));if(!i)return{host:"",port:null};let n=i[2].split("@").pop()||"",r=/^(\[[^\]]+\])(:|$)/.exec(n);if(r){let e=r[1];return{host:e,port:iK(n.substr(e.length+1))}}{let[e,t]=n.split(":");return{host:e,port:iK(t)}}}(t),l=null===a?"":`:${a}`;n.config.emulator={url:`${s}//${o}${l}/`},n.settings.appVerificationDisabledForTesting=!0,n.emulatorConfig=Object.freeze({host:o,port:a,protocol:s.replace(":",""),options:Object.freeze({disableWarnings:r})}),r||function(){function e(){let e=document.createElement("p"),t=e.style;e.innerText="Running in emulator mode. Do not use with production credentials.",t.position="fixed",t.width="100%",t.backgroundColor="#ffffff",t.border=".1em solid #000000",t.color="#b50000",t.bottom="0px",t.left="0px",t.margin="0px",t.zIndex="10000",t.textAlign="center",e.classList.add("firebase-emulator-warning"),document.body.appendChild(e)}"undefined"!=typeof console&&"function"==typeof console.info&&console.info("WARNING: You are using the Auth Emulator, which is intended for local testing only.  Do not use with production credentials."),"undefined"!=typeof window&&"undefined"!=typeof document&&("loading"===document.readyState?window.addEventListener("DOMContentLoaded",e):e())}()}(i,`http://${r}`),i}(uH),uB=async function(e,t,i){try{nm(uV,t,i).then(t=>{t.user,alert(`Your account: ${e} has been created`)})}catch(e){e.code,e.message}},uW=async function(e,t){try{nf(eZ(uV),i8.credential(e,t)).catch(async e=>{throw"auth/password-does-not-meet-requirements"===e.code&&ng(uV),e}).then(e=>{e.user,alert("Your logged in successfully")})}catch(e){console.log(e.code,e.message)}};uj.addEventListener("click",function(){eZ(uV).signOut().then(()=>{}).catch(e=>{})}),eZ(uV).onAuthStateChanged(e=>{e?(uq.style.display="flex",console.log("User is signed in:",e)):(uq.style.display="none",console.log("User is signed out"))},void 0,void 0),document.querySelector(".form-wrapper");const uz=document.querySelector(".submit-btn"),u$=document.querySelector(".sign-up-form");document.querySelector(".au-modal-close");const uK=document.querySelector("#name"),uG=document.querySelector('input[type="email"]'),uY=document.querySelector('input[type="password"]'),uX=document.querySelector(".sign-in-btn"),uJ=document.querySelector(".sign-up-btn"),uQ=document.querySelector(".form-item-render"),uZ=document.getElementById("name"),u0=function(){uz.textContent="Sign up",uQ.style.display="block"};u$.addEventListener("submit",e=>{e.preventDefault(),uz.textContent="Sign up";{let{value:e}=uK,{value:t}=uG,{value:i}=uY;""!==t&&""!==i&&""!==e&&uB(e,t,i)}uz.textContent="Sign in";{let{value:e}=uK,{value:t}=uG,{value:i}=uY;""!==t&&""!==i&&uW(t,i)}u$.reset(),u0()}),uX.addEventListener("click",function(){uz.textContent="Sign in",uQ.style.display="none",uZ.removeAttribute("required")}),uJ.addEventListener("click",u0);
//# sourceMappingURL=index.3a2ce8da.js.map
